                                    ...
                                    <tr>
                                        <th width=" 50px" style="background: #007BFF; color: white">No</th>
                                             ...
                                             <tr>
                                                 ...
                                                 <td>
                                                     <div class="progress">
                                                         <div class="progress-bar bg-<?= $color; ?> progress-bar-striped" role="progressbar" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100" style="width: <?= $value['kepercayaan'] ?>%"></div>
                                                     </div>
                                                 </td>
